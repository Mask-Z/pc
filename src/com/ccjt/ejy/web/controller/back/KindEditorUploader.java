/**  
 * 包名：com.ccjt.ejy.web.controller.back  
 * 文件名：KindEditorUploader.java  
 * 版本信息：V1.0  
 * 日期：2017年8月15日-上午10:26:19  
 * Copyright(c)2017
 *   
 */
 ...
 */
@Controller
public class KindEditorUploader{
    // windows
//  private String PATH_LINE = "\\";
    ...
    public void fileUpload(HttpServletRequest request, 
        ...
        try {
            ...
            //文件保存本地目录路径
            String savePath = request.getSession().getServletContext().getRealPath(PATH_LINE) + "upload/ueditor"+PATH_LINE;
            //文件保存目录URL
            String saveUrl = request.getContextPath() + PATH_LINE +"upload/ueditor"+PATH_LINE;
