...
<span style="padding-left: 5px">
            ...
            <select labelPosition="top" style="width:50%;" name="audit_result">
                ...
                <option value="2"
                        <c:if test="${zxdkApply.reviewinfo_shjg==2}">selected</c:if> >不完备
                </option>
                <option value="3"
                        <c:if test="${zxdkApply.reviewinfo_shjg==3}">selected</c:if> >已完备
                </option>
                </c:if>
                ...
                <option value="1"
                        <c:if test="${zxdkApply.reviewinfo_shjg==1}">selected</c:if> >待签署
                </option>
                <option value="3"
                        <c:if test="${zxdkApply.reviewinfo_shjg==3}">selected</c:if> >已签署
                </option>
                </c:if>
                ...
                <option value="1"
                        <c:if test="${zxdkApply.reviewinfo_shjg==1}">selected</c:if> >待放款
                </option>
                <option value="3"
                        <c:if test="${zxdkApply.reviewinfo_shjg==3}">selected</c:if> >已放款
                </option>
                </c:if>
                ...
                <option value="1"
                        <c:if test="${zxdkApply.reviewinfo_shjg==1}">selected</c:if> >待办理
                </option>
                <option value="4"
                        <c:if test="${zxdkApply.reviewinfo_shjg==4}">selected</c:if> >已提交
                </option>
                <option value="3"
                        <c:if test="${zxdkApply.reviewinfo_shjg==3}">selected</c:if> >已办理
                </option>
                </c:if>
        ...
        <div style="margin-bottom:20px">
         <span style="padding-left: 5px">
         <label class="label-top">额度:</label>
         </span>
            <input type="text" class="easyui-numberbox" style="width:50%;"  data-options="min:0,precision:2,prompt:'请输入,50.00~500.99(万元)之间'" name="apply_jkjeqr">
        </div>
        -->
        <div style="margin-bottom:20px">
    <span style="padding-left: 5px">
