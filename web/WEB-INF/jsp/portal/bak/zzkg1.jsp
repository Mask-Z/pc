...
<div class="clear"></div>
        ...
        <div class="product-intro">
			...
			<div class="detail-characteristic clearfix">
              <span class="label"><b>公共事业</b><i></i></span>
              <span class="label second"><b>建筑工程</b><i></i></span>
              <span class="label third"><b>建材</b><i></i></span>
            </div>
...
<!--                           <b class="org bold">10</b> 天 <b class="org bold">10</b> 时 <b class="org bold">10</b> 分 <b class="org bold">10</b>  秒 -->
            ...
            <div class="promotion clearfix">
            	<div class="list w100">
	                    <span class="laber">拟募集金额</span><span class="money">73,434,300.00 </span> 元
	                </div>
	                <div class="list w100">
	                    <span class="laber">拟新增注册资本</span><span class="money">52,040,816.00 </span>元 
	                </div>
	              <!--  
	              <div class="list w100">
	                 ...
	                 --> 
	                <div class="list w100">
	                    <span class="laber">保证金</span><span class="money">22,000,000.00 </span> 元
	                </div>
	                <div class="list w100">
	                    <span class="laber">行业</span><span class="fcdd3 f16">政府/公共事业,建筑/建材/工程</span> 
	                </div>
	                <div class="list w100">
	                    <span class="laber">所在地</span><span class="fcdd3 f16">益阳市赫山区长坡路桃花宾馆</span> 
	                </div>
            </div>
...
<div class="product_about">
    ...
    <div class="merchants">
        <ul class="merchants-title">
            <li><a href="javascript:;" target="_blank"><img src="<%=basePath%>html/img2/czcq-ico-5.png" alt="湖南省联合产权交易所"  height="50"></a></li>
            <li><a href="javascript:;" target="_blank">湖南省联合产权交易所</a></li>
        </ul>
