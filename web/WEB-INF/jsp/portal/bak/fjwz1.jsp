...
<!-- 				<a href="javascript:$('#audioli').click();" class="share-btn audio have"><i></i>一键收听</a> -->
        ...
        <div class="product-intro">
			...
			<div class="detail-characteristic clearfix">
              <span class="label"><b>七成新</b><i></i></span>
              <span class="label second"><b>电力设备</b><i></i></span>
...
<!--                           <b class="org bold">10</b> 天 <b class="org bold">10</b> 时 <b class="org bold">10</b> 分 <b class="org bold">10</b>  秒 -->
            ...
            <div class="promotion clearfix">
                ...
                <c:if test="${info.ispllr != '1'  }">
                	<div class="list w100">
	                    <span class="laber">转让底价 </span><span class="money">10,106.86</span> 元
	                </div>
	                
	                <div class="list w100">
	                    <span class="laber">保证金 </span><span class="money">5,000.00</span> 元
	                </div>
<!-- 	                <div class="list"> -->
...
<table border="0" cellspacing="0" cellpadding="0" width="890" style="" class="base-sw">
  <tr>
    ...
    <td width="151" colspan="2"><p align="left">吊机、电子汽车衡等一批废旧资产转让公告 </p></td>
    <td width="153" colspan="4" class="shheh" ><p align="center">项目编号 </p></td>
    <td width="143" colspan="2"><p align="left">01WZ20170051</p></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="84" rowspan="10" class="shheh" ><p align="center">标的 <br />
      概况 </p></td>
    <td width="520" colspan="9"><p align="left">标的清单 </p></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="85"><p align="left">电子汽车衡 </p></td>
    <td width="66"><p align="left">SCS-60T</p></td>
    <td width="69"><p align="left">1</p></td>
    <td width="82" colspan="2"><p align="left">台 </p></td>
    <td width="145" colspan="3"><p align="left">­­ 4785</p></td>
  </tr>
  <tr>
    <td width="73"><p align="left">2</p></td>
    <td width="85"><p align="left">料斗 </p></td>
    <td width="66"><p align="left">&nbsp;</p></td>
    <td width="69"><p align="left">1</p></td>
    <td width="82" colspan="2"><p align="left">台 </p></td>
    <td width="145" colspan="3"><p align="left">2250 </p></td>
  </tr>
  <tr>
    <td width="73"><p align="left">3</p></td>
    <td width="85"><p align="left">吊机 </p></td>
    <td width="66"><p align="left">3T</p></td>
    <td width="69"><p align="left">1</p></td>
    <td width="82" colspan="2"><p align="left">台 </p></td>
    <td width="145" colspan="3"><p align="left">24750</p></td>
  </tr>
  <tr>
    <td width="73"><p align="left">4</p></td>
    <td width="85"><p align="left">油罐 </p></td>
    <td width="66"><p align="left">10T</p></td>
    <td width="69"><p align="left">1</p></td>
    <td width="82" colspan="2"><p align="left">只 </p></td>
    <td width="145" colspan="3"><p align="left">4000</p></td>
  </tr>
  <tr>
    <td width="159" colspan="2"><p align="left">合计 </p></td>
    <td width="66"><p align="left">&nbsp;</p></td>
    <td width="69"><p align="left">4</p></td>
    <td width="82" colspan="2"><p align="left">&nbsp;</p></td>
    <td width="145" colspan="3"><p align="left">35785</p></td>
  </tr>
  <tr>
    <td width="73" class="shheh" ><p align="center">转让低价 </p></td>
    <td width="447" colspan="8"><p align="left">10106.86元 </p></td>
  </tr>
  <tr>
    ...
    <td width="447" colspan="8"><p align="left">1.标的为报废资产，均无随机附件及图纸、说明书、保修单、维修手册等相关资料，部分资产已破损、残缺，以实物现状为准，常州产权交易所对竞价标的所涉及的具体范围、品名、型号、数量、品质等均不作承诺保证，不承担一切瑕疵担保责任。 <br />
      2.上述资产存放于新北区北海中路北侧为民桥附近（江苏省电力公司新龙220KV变电站东侧）。标的须买受人自行拆除拆解，人工、运输成本较大，清单仅供参考，成交后按资产实际现状交接，不调整成交价格。 </p></td>
  </tr>
  <tr>
...
<table border="0" cellspacing="0" cellpadding="0" width="890" style="" class="base-sw">
  <tr>
    ...
    <td width="520" colspan="9"><p>1.竞价成交后，买受人向产交所支付的服务费，产交所开具服务费发票，产交所不开具其他任何票据。如买受人需要销售发票，由其自行向税务机关申报办理，税金由买受人另行承担。 <br />
      2.注册会员参与项目时，应严格遵照《<a href="http://www.czcq.com.cn/jygz/cqjy/88903.shtml">常州产权交易所注册会员管理办法</a><a name="_Hlt441586450" id="_Hlt441586450"></a><a name="_Hlt441586470" id="_Hlt441586470"></a>》、<a href="http://www.czcq.com.cn/jygz/cqjy/88901.shtml">《常州产权交易所低值资产交易办法》</a>的相关规定。资产占有单位（委托方）将对其服务进行评价，评价结果列入考核。 <br />
      3.买受人提取标的完毕须将《资产交割书》交至常州产权交易所，否则常州产权交易所有权暂停其注册会员资格，并限制其参与常州产权交易所组织的其它竞价活动，直至提交资料后恢复其会员资格。 <br />
      4.买受人对标的物有争议的，在争议处理期间，常州产权交易所有权暂停其注册会员资格，并限制其参与常州产权交易所组织的其它竞价活动，直至争议处理完毕后恢复其会员资格。 <br />
      5.竞买人参与竞价前应按照<a href="http://www.e-jy.com.cn/ejy/infodetail/?infoid=8defe6be-98a0-4f67-aa82-d796da329811&amp;categoryNum=033">《数字证书申领指南》</a><a name="_Hlt441756188" id="_Hlt441756188"></a><a name="_Hlt441756187" id="_Hlt441756187"></a>要求领取竞价CA。 <br />
      6.竞买人自备终端进行网络竞价，本所不提供竞价场所。 </p></td>
  </tr>
    </table>
  </div>
  <br />
...
<table border="0" cellspacing="0" cellpadding="0" width="890" style="" class="base-sw">
  <tr>
    <td width="84" class="shheh"  rowspan="3"><p align="center">交易 <br />
      条件 </p></td>
  ...
  <tr>
    ...
    <td width="447" colspan="8"><p>竞买人必须为常州产权交易所低值实物资产竞买人注册会员，申请成为低值实物资产注册竞买人会员详见《<a href="http://www.czcq.com.cn/jygz/cqjy/88903.shtml">常州产权交易所注册会员管理办法</a><a name="_Hlt441755847" id="_Hlt441755847"></a><a name="_Hlt441755849" id="_Hlt441755849"></a>》。 </p></td>
  </tr>
  <tr>
    <td width="73" class="shheh" ><p align="center">标的交割 </p></td>
    <td width="447" colspan="8"><p align="left"><strong>1.</strong><strong>交割时间:</strong> 2017年6月21日17:00前办理交割，2017年6月26日17:00前提取完毕。 <br />
      ...
      （5）<strong>买受人负责标的的拆卸和搬运，在标的拆卸和搬运过程中必须严格遵守国家、地方安全和环境保护等方面有关法律、法规，如发生安全、环境等事故的，由买受人承担一切责任。</strong> <br />
      ...
      （5）因交易标的为废旧资产，买受人不得以受让标的缺少铭牌、技术资料、整机缺件等为理由提出赔偿或退标。 </p></td>
  </tr>
      </table>
  </div>
  <br />
...
<table border="0" cellspacing="0" cellpadding="0" width="890" style="" class="base-sw">
  ...
  <tr>
    ...
    <td width="447" colspan="8"><p align="left">1.时间: 2017年6月15日9:00（看样请联系徐先生：15061974506    ）。 <br />
      2.地点: 新北区北海中路北侧为民桥附近（江苏省电力公司新龙220KV变电站东侧）。 </p></td>
  </tr>
  <tr>
    <td width="73" class="shheh"  rowspan="2"><p align="center">竞买报名 </p></td>
    <td width="151" class="shheh"  colspan="2"><p align="center">报名截止时间 </p></td>
    <td width="296" colspan="6"><p>2017年6月18日 </p></td>
  </tr>
  <tr>
    <td width="151" class="shheh"  colspan="2"><p align="center">保证金及处置方式 </p></td>
    <td width="296" colspan="6"><p align="left">1.缴纳：金额<u> 5000 </u>元，截止时间<u> 2017年6月16日17:00止</u>，按系统提示缴纳。 <br />
  ...
  <tr>
    ...
    <td width="104" colspan="2"><p align="left">2017年6月19日14:00至14:30止 </p></td>
  ...
  <tr>
    ...
    <td width="447" colspan="8"><p align="left">成交价的<u>&nbsp;5 %</u>，成交之日起<u>2</u>个工作日内按系统提示付清。 </p></td>
  </tr>
  <tr>
    <td width="84" class="shheh"  rowspan="5"><p align="center">联系 <br />
      方式 </p></td>
    <td width="73" class="shheh" ><p align="center">标的咨询 </p></td>
    <td width="447" colspan="8"><p align="left">李先生 0519-86601526&nbsp;&nbsp; 18168810102</p></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="447" colspan="8"><p align="left">自公告之日起至2017年6月16日17:00止（节假日除外） </p></td>
  </tr>
  <tr>
...
// 				            		out.println("<td nowarp><button class=\"new-jygg-btn\" onclick=\"jjdt_detail(this ,'" + jjdt.get("projectGuid") + "')\">竞价详情</button></td>");
       ...
       <div class="detail-con-right">
            <div class="right-list clearfix">
                    ...
                    <ul class="clearfix">
                            <li>
                                <a href="eweb/infodetail?infoid=9d67b120-8703-483b-8e45-f63e2aa305b1&categoryNum=001001004&pageName=fjwz2" title="">
                                    <img src="images/linshi/20170801155949001.gif" width="100%" title="">
                                    <dl>
                                        <dt><span class="fcdd3">[常州市]</span>[常州产权交易所]报废草包一批竞价公告</dt>
                                        <dd>
                                            <span>转让底价：<span  class="fcdd3">57,000.00元</span></span>
                                        </dd>
                                    </dl>
                                </a>
                            </li>
