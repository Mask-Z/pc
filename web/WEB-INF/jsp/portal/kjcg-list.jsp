...
<head>
    ...
    <script src="<%=basePath%>js/kjcg/list.js"></script>
	<style type="text/css">
		dd{
			cursor: pointer;
		}
...
<body>
       ...
       <div class="crumbs clearfix">
        <div class="fl">
            ...
            <a href="<%=basePath%>kjcg_more">快捷采购</a>&gt;
          </div>
                       ...
                       <c:when test="${type eq 'cggg'}">
                           <ul class="clearfix five">
                               ...
                               <c:forEach items="${rows }" var="info">
                                   <li>
                                       <div class=" title"><a
                                               href="<%=basePath %>newsinfo?tag=kjcg&infoid=${info.infoID}"
                                               target="_blank" title="${info.biaoduanname }">${info.biaoduanname }</a>
                                       </div>
                                       <div class="item">
