		       ...
		       <div class="crumbs clearfix">
		        <div class="fl">
		            <a href="<%=basePath%>index" target="_blank">首页</a>
		              &gt; 
		                <a href="<%=basePath%>index" target="_blank">重点推荐</a>
		                &gt;${zdxmDetail.activityName}
		          </div>
		      </div>
        </div>
		<div class="k1200">
		    <div class="detail-box">
		        <div class="box">
		   			    <h1>${zdxmDetail.activityName}</h1>
				        <div class="time">发布时间 ${zdxmDetail.activityBeginTime}</div>
				        <div class="box">
				   			${zdxmDetail.activityContent }
		                </div>
		         </div>
		    </div>
		  </div>       
